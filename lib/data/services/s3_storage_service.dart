    ...
    return initResult.when(
      success: (_) async {
        ...
        try {
          ...
          AppLogger.debug('S3StorageService.uploadFile: Uploaded file $key to $bucket');
    ...
    return initResult.when(
      success: (_) async {
        try {
          ...
          AppLogger.debug('S3StorageService.downloadFile: Downloaded file $key from $bucket (${data.length} bytes)');
